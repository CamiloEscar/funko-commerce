...
export const Cart = () => {
  ...
  return (
    <div className="flex flex-col h-full">
      <div className="px-5 py-7 flex justify-center items-center border-b border-slate-200">
      ...
      {totalItemsInCart > 0 ? (
        ...
        <div className="flex flex-col items-center justify-center h-full gap-7">
          ...
          <Link
            to="/celulares"
            className="py-4 bg-black rounded-full text-white px-7 text-xs tracking-widest font-semibold"
            onClick={closeSheet}
          >
            Empezar a comprar
          </Link>
