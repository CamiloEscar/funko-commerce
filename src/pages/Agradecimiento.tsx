    ...
    <div className="flex flex-col h-screen">
      ...
      <main className="container flex-1 flex flex-col items-center gap-10">
        ...
        <div className="border border-slate-200 w-full md:w-[600px] p-5 rounded-md space-y-3">
          ...
          <p className="text-sm">
            Gracias por realizar tu compra en FunkosShop. Para realizar la
            transferencia te compartimos los siguientes datos
          </p>

          <div className="space-y-0.5 text-sm">
            <p>Compra a traves de Mercado pago</p>
            <p>Transferencia bancaria</p>
            <p>Razon Social: FunkosHop</p>
            <p>CBU: 012345678912345678</p>
          </div>
          <p className="text-sm">
            Una vez realizada la transferencia, comparte tu comprobante a
            ventas@funkosshop.com para procesar y hacerle la entrega a domicilio
          </p>
        </div>

        <div className="border border-slate-200 w-full space-y-3 md:w-[600px]">
          ...
          <div className="flex flex-col gap-5">
            ...
            <div className="flex flex-col text-sm">
              ...
              <p>Deposito bancario - {data.totalAmount}</p>
            </div>
