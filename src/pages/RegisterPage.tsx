...
//usamos zod que es un esquema de validacion de formularios como el registro
...
export const RegisterPage = () => {
  ...
  return (
    <div
      className="h-full flex flex-col items-center mt-12 gap-5
    "
    >
      <h1 className="text-4xl font-bold capitalize">Registrate</h1>
      <p className="text-sm font-medium">
        Ingresa tus datos para crear una cuenta en Funko Commerce
      </p>
      {isPending ? (
