...
export const CellPhonePage = () => {
  ...
  //funcion para cargar al carrito
  const addToCart = () => {
    if (selectedVariant) {
      addItem({
      ...
      toast.success("Agregado al carrito", { position: "bottom-right" });
    }
  };
  ...
  //resetear el slug actual cuando se cambia la url
  useEffect(() => {
    setCurrentSlug(slug)

    //tambien reiniciar color, almacenamiento, variante
